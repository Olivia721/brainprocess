function varargout = process_wpli1n( varargin )
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.Comment     = 'Weighted phase lag index (wPLI) NxN';
    ...
    % === KEEP TIME
    sProcess.options.keeptime.Comment = 'Keep time information, and estimate the wPLI across trials<BR>(requires the average of many trials)';
...
function Test() %#ok<DEFNU>
    ...
    % Coherence process
    sTmp = bst_process('CallProcess', 'process_wpli1n', sFile, [], ...
